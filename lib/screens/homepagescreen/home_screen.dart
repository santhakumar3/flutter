...
import 'package:test_app/screens/homepagescreen/item_screen.dart';
                    ...
                    itemBuilder: (context, index){
                      return Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            Image.asset("lib/assets/images/${foods[index]}.png",
                            height: 80,
                            width: 80,),
                            Text(
                              foods[index],
                              ...
                              child: Column(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.asset("lib/assets/images/${foods2[index]}.png",
                                    height: 120,
                                    width: MediaQuery.of(context).size.width / 1.4 ,
                                    fit: BoxFit.cover,
                                    ),
